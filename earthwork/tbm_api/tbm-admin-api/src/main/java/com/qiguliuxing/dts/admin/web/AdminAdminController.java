...
import com.qiguliuxing.dts.db.service.TbmAdminService;
...
public class AdminAdminController {
	...
	@Autowired
	private TbmAdminService adminService;
	...
	public Object list(String username, @RequestParam(defaultValue = "1") Integer page,
		...
		List<TbmAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
	...
	private Object validate(TbmAdmin admin) {
	...
	@PostMapping("/create")
	public Object create(@RequestBody TbmAdmin admin) {
		...
		List<TbmAdmin> adminList = adminService.findAdmin(username);
		if (adminList.size() > 0) {
	...
	public Object read(@NotNull Integer id) {
		...
		TbmAdmin admin = adminService.findById(id);
	...
	@PostMapping("/update")
	public Object update(@RequestBody TbmAdmin admin) {
	...
	@PostMapping("/delete")
	public Object delete(@RequestBody TbmAdmin admin) {
