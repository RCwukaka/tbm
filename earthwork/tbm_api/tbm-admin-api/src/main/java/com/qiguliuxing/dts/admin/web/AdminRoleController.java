...
import com.qiguliuxing.dts.db.service.TbmPermissionService;
import com.qiguliuxing.dts.db.service.TbmRoleService;
...
public class AdminRoleController {
	...
	@Autowired
	private TbmRoleService roleService;
	@Autowired
	private TbmPermissionService permissionService;
	...
	public Object list(String name, @RequestParam(defaultValue = "1") Integer page,
		...
		List<TbmRole> roleList = roleService.querySelective(name, page, limit, sort, order);
	...
	public Object options() {
		List<TbmRole> roleList = roleService.queryAll();
	...
	public Object read(@NotNull Integer id) {
		...
		TbmRole role = roleService.findById(id);

		logger.info("【请求结束】系统管理->角色管理->角色详情,响应结果:{}", JSONObject.toJSONString(role));
		return ResponseUtil.ok(role);
	}

	private Object validate(TbmRole role) {
	...
	@PostMapping("/create")
	public Object create(@RequestBody TbmRole role) {
	...
	@PostMapping("/update")
	public Object update(@RequestBody TbmRole role) {
	...
	@PostMapping("/delete")
	public Object delete(@RequestBody TbmRole role) {
	...
	public Object updatePermissions(@RequestBody String body) {
		...
		for (String permission : permissions) {
			TbmPermission DtsPermission = new TbmPermission();
