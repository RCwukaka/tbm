...
public class AdminRegionController {
	...
	@Autowired
	private TbmRegionService regionService;

	@GetMapping("/clist")
	public Object clist(@NotNull Integer id) {
		List<TbmRegion> regionList = regionService.queryByPid(id);
	...
	public Object list(String name, Integer code, @RequestParam(defaultValue = "1") Integer page,
		...
		List<TbmRegion> regionList = regionService.querySelective(name, code, page, limit, sort, order);
